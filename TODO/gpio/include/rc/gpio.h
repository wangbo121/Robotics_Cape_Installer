...
//  */
// typedef enum rc_gpio_direction_t{
// 	GPIO_INPUT_PIN,
// 	GPIO_OUTPUT_PIN
// }rc_gpio_direction_t;
 ...
 *
 * @param[in]  pin   The pin ID
 * @param[in]  edge  The edge_dir, see rc_gpio_edge_t
 *
 * @return     0 on success, -1 on failure
 */
int rc_gpio_set_edge(int pin, rc_gpio_edge_t edge_dir);
